...
const alertVariants = cva("relative rounded-xl border px-3.5 py-3 text-card-foreground text-sm", {
  ...
  variants: {
    ...
    variant: {
      ...
      // Pill-shaped notices that sit inside the sidebar's group padding.
      "sidebar-notice":
        "rounded-2xl border-border/40 bg-accent/40 text-muted-foreground text-xs [&_[data-slot=alert-title]]:text-foreground",
      "sidebar-warning":
        "rounded-2xl border-warning/40 bg-warning/8 text-warning-foreground text-xs [&_[data-slot=alert-description]]:text-warning-foreground/80 [&_svg]:text-warning",
      error:
